...
const chapters = [
  ...
  { id: '31', path: '/smart-health-record', title: 'پرونده سلامت هوشمند', subtitle: 'Smart Health Record', icon: Target },
  { id: '32', path: '/ai-doctor', title: 'پزشک هوشمند', subtitle: 'AI Doctor', icon: Target },
  { id: '33', path: '/ai-orchestration-platform', title: 'پلتفرم هوش مصنوعی مرکزی', subtitle: 'AI Orchestration Platform', icon: Target },
  { id: '34', path: '/agent-platform', title: 'سیستم‌عامل ایجنت‌های پزشکی', subtitle: 'Agent Platform', icon: Target },
  { id: '35', path: '/healthcare-knowledge-graph', title: 'گراف دانش سلامت', subtitle: 'Healthcare Knowledge Graph', icon: Target },
  { id: '36', path: '/digital-human-platform', title: 'همزاد دیجیتال سلامت', subtitle: 'Digital Human Platform', icon: Target },
  { id: '37', path: '/healthcare-super-app', title: 'سوپر اپلیکیشن سلامت', subtitle: 'Healthcare Super App', icon: Target },
  { id: '38', path: '/healthcare-enterprise-platform', title: 'پلتفرم سازمانی سلامت', subtitle: 'Healthcare Enterprise Platform', icon: Target },
  { id: '39', path: '/healthcare-data-ai-platform', title: 'پلتفرم داده و هوش مصنوعی', subtitle: 'Healthcare Data & AI Platform', icon: Target },
  { id: '40', path: '/healthcare-ecosystem-strategy', title: 'استراتژی اکوسیستم سلامت', subtitle: 'Healthcare Ecosystem Strategy', icon: Target },
  { id: '41', path: '/platform-architecture', title: 'معماری کلان پلتفرم', subtitle: 'Platform Architecture', icon: Target },
  { id: '42', path: '/engineering-platform', title: 'معماری مهندسی و توسعه', subtitle: 'Engineering Platform', icon: Target },
  { id: '43', path: '/haios', title: 'سیستم‌عامل هوش مصنوعی سلامت', subtitle: 'HAIOS', icon: Target },
  { id: '44', path: '/business-operating-system', title: 'سیستم‌عامل کسب‌وکار', subtitle: 'Business Operating System', icon: Target },
  { id: '45', path: '/healthcare-ai-constitution', title: 'قانون اساسی هوش مصنوعی', subtitle: 'Healthcare AI Constitution', icon: Target },
  { id: '46', path: '/healthcare-reference-architecture', title: 'معماری مرجع سلامت', subtitle: 'Healthcare Reference Architecture', icon: Target },
