    ...
    >
      <div className="eks-hero-box">
        ...
        <p>
          ...
          اما اگر Knowledge از بین برود، حتی با بهترین برنامه‌نویس‌ها، بازسازی پروژه سال‌ها طول می‌کشد. 
      ...
      <section className="chapter-section">
        <div className="digital-twin-org">
          ...
          <p>
            همانطور که برای بیمار Digital Twin ساختیم، برای خود شرکت نیز همزاد دیجیتال می‌سازیم. 
