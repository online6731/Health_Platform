...
export default function Chapter44() {
  return (
    <ChapterLayout 
      title="فصل ۴۴: سیستم‌عامل کسب‌وکار" 
      englishTitle="Business Operating System"
    >
      <div className="construction-container">
        ...
        <h2>در حال تکمیل...</h2>
        <p>
          محتوای این فصل با عنوان <strong>«سیستم‌عامل کسب‌وکار»</strong> هم‌اکنون توسط تیم هوش مصنوعی و مهندسی در حال تدوین است.
