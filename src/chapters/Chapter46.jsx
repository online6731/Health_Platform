...
export default function Chapter46() {
  return (
    <ChapterLayout 
      title="فصل ۴۶: معماری مرجع سلامت" 
      englishTitle="Healthcare Reference Architecture"
    >
      <div className="construction-container">
        ...
        <h2>در حال تکمیل...</h2>
        <p>
          محتوای این فصل با عنوان <strong>«معماری مرجع سلامت»</strong> هم‌اکنون توسط تیم هوش مصنوعی و مهندسی در حال تدوین است.
