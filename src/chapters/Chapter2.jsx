        ...
        <div className="timeline-container">
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <ul>
                <li>تمرکز بر یک نیچ مشخص (مثلاً دستیار هوشمند پیگیری بیماران مزمن برای کلینیک‌ها)</li>
                <li>توسعه مدل بنیادین اولیه برای زبان و فرهنگ بومی با داده‌های پایلوت و باکیفیت</li>
                <li>شروع جمع‌آوری داده‌های اختصاصی (Proprietary Data) به‌عنوان خندق دفاعی (Moat)</li>
                <li>اثبات اثربخشی بالینی و ارزش‌آفرینی اقتصادی (ROI) در مقیاس کوچک</li>
              </ul>
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              ...
              <ul>
                <li>استقرار کامل معماری چندعاملی (Multi-Agent) برای ارکستراسیون پیشرفته و خودکار</li>
