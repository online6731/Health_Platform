...
import {
  Cpu, Layers, Database, UserCheck, Stethoscope, Workflow,
  Lightbulb, Activity, Brain, Clock, Blocks, Network, TabletSmartphone,
  ...
  return (
    ...
    >
      ...
      <div className="glass-panel p-6 mb-8 border-r-4 border-r-[var(--accent-blue)]">
        <h3>۴-۱ مقدمه</h3>
        <p>
          چشم‌انداز بلندمدت، یکپارچه‌سازی داده و خدمات سلامت است؛ اما محصول نخست باید محدود بماند: گردآوری شرح حال ساختاریافته، نمایش سوابق واردشده و کمک به یافتن مسیر مراقبت با نظارت انسانی. سایر ماژول‌ها گزینه‌های آینده‌اند، نه قابلیت تحویل‌شده.
        </p>
        <p style={{marginTop: '1rem'}}>
          یک هسته مشترک فقط زمانی ارزشمند است که رضایت، تفکیک هدف استفاده، کمینه‌سازی داده و مسئولیت هر ارائه‌دهنده حفظ شود. پلتفرم نباید برای کامل‌بودن، همه داده‌ها یا همه خدمات را متمرکز کند.
        </p>
      </div>

      <section className="chapter-section">
        <h3><Workflow className="section-icon" /> قرارداد محصول برای نسخه اول</h3>
        <div className="grid-3-col">
          <div className="premium-card p-6">
            <h4>شروع مسیر</h4>
            <p>کاربر بزرگسال در وضعیت غیراضطراری، با رضایت، اطلاعات خوداظهاری را ثبت می‌کند.</p>
          </div>
          <div className="premium-card p-6">
            <h4>خروجی سامانه</h4>
            <p>خلاصه پیشنهادی با منبع، داده گمشده و امکان اصلاح؛ همراه وضعیت و اقدام بعدی ارجاع.</p>
          </div>
          <div className="premium-card p-6">
            <h4>مالک تصمیم</h4>
            <p>کارکنان مرکز خروجی را بازبینی می‌کنند؛ درمانگر مسئول هر تصمیم پزشکی باقی می‌ماند.</p>
          </div>
        </div>
        <div className="glass-panel p-6 mt-5 border-r-4 border-r-red-500">
          <strong>معیار پذیرش هنوز لازم است:</strong> زمان تکمیل، نرخ رهاکردن، درصد اصلاح خلاصه، خطای بحرانی،
          تکمیل ارجاع و رضایت باید با baseline و آستانه توافق‌شده سنجیده شوند.
        </div>
      </section>
      ...
      <section className="chapter-section">
        ...
        <div className="philosophy-grid">
          <div className="philosophy-card">
            ...
            <h4>پیوستگی مسیر، نه تجمیع همه داده</h4>
            <p>اطلاعات لازم میان مراحل منتخب منتقل می‌شود، بدون ساخت پروفایل جامع خارج از هدف.</p>
          </div>
          <div className="philosophy-card">
            <Database size={36} className="philosophy-icon" />
            <h4>داده‌محوری</h4>
            <p>منشأ، زمان، کیفیت، داده گمشده و امکان اصلاح باید همراه هر اطلاعات نمایش داده شود.</p>
          </div>
          <div className="philosophy-card">
            <Cpu size={36} className="philosophy-icon" />
            <h4>AI به‌عنوان توانمندساز</h4>
            <p>AI برای خلاصه یا جست‌وجوی محدود آزمون می‌شود و بدون مزیت روشن نسبت به روش ساده وارد محصول نمی‌شود.</p>
          </div>
          <div className="philosophy-card">
            <Clock size={36} className="philosophy-icon" />
            <h4>پیگیری محدود و مسئول‌دار</h4>
            <p>پیگیری فقط در بازه و هدف توافق‌شده انجام می‌شود و جایگزین پایش پزشکی مستمر نیست.</p>
          </div>
          <div className="philosophy-card">
      ...
      <div className="conclusion-box">
        ...
        <p>
          راهکار فعلی یک <strong>پروپوزال محصول و معماری</strong> است. ارزش MVP باید با کاهش دوباره‌کاری اطلاعات و بهبود تکمیل ارجاع سنجیده شود؛ پزشکی دقیق، عامل خودمختار و پیش‌بینی سلامت فقط پس از شواهد، کنترل خطر و مجوز وارد دامنه می‌شوند.
        </p>
      </div>
