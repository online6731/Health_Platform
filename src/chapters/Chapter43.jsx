...
export default function Chapter43() {
  return (
    <ChapterLayout 
      title="فصل ۴۳: سیستم‌عامل هوش مصنوعی سلامت" 
      englishTitle="HAIOS"
    >
      <div className="construction-container">
        ...
        <h2>در حال تکمیل...</h2>
        <p>
          محتوای این فصل با عنوان <strong>«سیستم‌عامل هوش مصنوعی سلامت»</strong> هم‌اکنون توسط تیم هوش مصنوعی و مهندسی در حال تدوین است.
