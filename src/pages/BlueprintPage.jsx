...
const openDecisions = [
  ...
  ['دامنه دقیق سرویس اول', 'تغذیه انتخاب شده است؛ پرسونای دقیق، وعده، موارد پذیرش و خروج باید در Discovery تأیید یا اصلاح شوند.'],
...
export default function BlueprintPage() {
  return (
    <>
      <PageIntro
        eyebrow="تعریف نقطه ورود · نسخه ۴"
        title="از ایده گسترده به مجموعه‌ای از تصمیم‌های قابل آزمون."
        description="سرویس اول انتخاب شده است؛ این صفحه نشان می‌دهد دامنه، تقاضا، ایمنی و اقتصاد آن چگونه باید پیش از ساخت و عرضه اثبات یا بازتعریف شوند."
      >
        <div className="page-intro__meta">
          <span><Target size={16} /> سرویس اول: تغذیه و عادت‌های سلامت</span>
          <span><CircleHelp size={16} /> شواهد بازار: هنوز باز</span>
        </div>
      </PageIntro>
      ...
      <section className="section section--tinted">
        <div className="container candidate-grid">
          <div>
            <SectionHeader
              eyebrow="اعتبارسنجی سرویس اول"
              title="انتخاب انجام شده؛ اکنون باید با شش معیار آزموده شود."
              description="دسترسی بنیان‌گذار به کاربر، متخصص یا کانال و نتایج Discovery تعیین می‌کند که این دامنه حفظ، اصلاح یا متوقف شود."
            />
          ...
          <aside className="recommendation-card">
            <StatusBadge tone="candidate">سرویس اول · منتخب برای اعتبارسنجی</StatusBadge>
            <span className="recommendation-card__icon"><Sparkles size={28} /></span>
            <h2>تغذیه روزمره و عادت‌سازی</h2>
            <p>این دامنه اولیه به بزرگسالان کم‌خطر و عادت‌های روزمره محدود شده است؛ مسئله، پرسونای دقیق، سطح ریسک، قیمت و عملیات باید در پژوهش و ارزیابی تخصصی تأیید یا بازتعریف شوند.</p>
            ...
            <small>این تصمیم محصول فعال، نتیجه واقعی یا ادعای آمادگی بازار نیست.</small>
          </aside>
        </div>
      </section>
